    ...
    <div className="card p-6 flex flex-col sm:flex-row gap-5">
      ...
      <div className="flex-1 min-w-0">
        <div className="flex flex-wrap items-start justify-between gap-3 mb-2">
          <div>
            <h3 className="text-lg font-bold text-theme-text">{user.name}</h3>
            <p className="text-sm text-theme-muted">@{user.username}</p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-4">
          {user.email && (
            <a
              ...
              className="flex items-center gap-1.5 text-xs text-theme-muted hover:text-primary-600 transition-colors"
            >
