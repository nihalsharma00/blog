        ...
        <div className="max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white text-black text-sm font-bold hover:bg-primary-50 transition-colors duration-200 group/btn self-start sm:self-auto flex-shrink-0"
            >
              Read Article
